...
if(isset($_POST['submit'])) {
    ...
    $sql = "UPDATE siswa SET nama='$nama', jurusan='$jurusan', kelas='$kelas' WHERE nis='$nis'";
...
<head>
    ...
    <title>Edit Data Siswa - CRUD App</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="container">
        <div class="header">
            ...
            <p>Update data siswa <?= $data['nama']; ?></p>
        </div>
        ...
        <div class="content">
            ...
            <form method="POST">
                <div class="form-group">
                    <label>NIS</label>
                    <div class="nis-display"><?= $data['nis']; ?></div>
                    <small style="color: #86B6F6;">NIS tidak dapat diubah</small>
                </div>
                ...
                <div class="btn-group">
                    <button type="submit" name="submit" class="btn btn-submit">💾 Update Data</button>
